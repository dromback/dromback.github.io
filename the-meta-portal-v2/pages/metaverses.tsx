...
const Metaverses = () => {
    ...
    const decentraland = "/images/Decentraland.png"
    const sandbox = "/images/The Sandbox.png"
    const roblox = "/images/roblox.png"
    const axie = "/images/axie.png"
    const fortnite = "/images/Fortnite-Logo_edited.png"
    const minecraft = "/images/minecraft.png"
    const bloktopia = "/images/Blok Icon.png"
    const highstreet = "/images/highstreet.png"
    const singularity6 = "/images/Singularity6.jpg"
    const portals = "/images/Portals.png"
    const upland = "/images/Upland.png"
    const metahero = "/images/metahero.png"
    const cryptovoxels = "/images/cryptovoxels.png"
    const mobox = "/images/mobox.png"
    const nakamoto = "/images/nakamoto.png"
    const vulcan = "/images/VForged.png"
    const dvision = "/images/Dvision.png"
    const ceek = "/images/CEEK.png"
    const alice = "/images/Alice.png"
    const somnium = "/images/Somnium.png"
    const staratlas = "/images/staratlas.png"
    const ufo = "/images/UFO.png"
    const ygg = "/images/ygg.jpg"
    const metamon = "/images/metamon.png"
    const rfox = "/images/rfox.png"
    const solice = "/images/Solice.png"
    const wilder = "/images/wilderworld.png"
    const illuvium = "/images/illuvium.png"
    const godsunchained = "/images/Gods Unchained.png"
    const otherside = "/images/otherside.png"
