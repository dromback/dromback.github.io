    ...
    return(
        ...
        <Box>
                ...
                <Box w="175px" h="120px" mt="1" ml="1" position="relative" top="-372px" left="175px" _hover={{bg: '#121212'}}>
                    <Box as="a" href="/minecraft" >
                        <Image ml="6" position="relative" top="10px" left="5px" maxW="70%" borderRadius="lg" boxShadow="2px 2px 2px black" src={minecraft} alt="Minecraft"/>
                        <Text position="relative" top="10px" left="55px" color="white">Minecraft</Text>
                    </Box>
                </Box>
                <Box w="175px" h="120px" mt="1" ml="1" position="relative" top="-372px" left="175px" _hover={{bg: '#121212'}}>
                    <Box as="a" href="/fortnite" >
                        <Image ml="6" position="relative" top="15px" maxW="75%" borderRadius="lg" boxShadow="2px 2px 2px black" src={fortnite} alt="Fortnite"/>
                        <Text position="relative" top="20px" left="60px" color="white">Fortnite</Text>
                    </Box>
                </Box>
                 
                <Box w="175px" h="120px" mt="1" ml="1" position="relative" top="-372px" left="175px" _hover={{bg: '#121212'}}>
                    <Box as="a" href="/axie-infinity" >
                        <Image ml="6" position="relative" top="15px" maxW="75%" borderRadius="lg" boxShadow="2px 2px 2px black" src={axie} alt="Axie Infinity"/>
