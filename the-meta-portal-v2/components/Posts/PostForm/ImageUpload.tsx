            ...
            {selectedFile ? (
                <>
                    ...
                    <Stack direction='row' mt='4'>
                        <Button h='28px' onClick={() => setSelectedTab('Post')}>Back to Post</Button>
                        <Button variant='outline' h='28px' onClick={() => setSelectedFile('')} > Remove </Button>
                    </Stack>
                </>
    ) : (
        <Flex justify='center' align='center' p='20' border='1px dashed' borderColor='gray.200' w='100%' borderRadius='4'>
