import { Box, Button, Flex, Icon, Text, Image, useColorModeValue } from '@chakra-ui/react';
...
const Header: React.FC<HeaderProps> = ({ metaverseData }) => {
    ...
    return (
        <>
            ...
            <title> Intervrs | Metaverses | {metaverseStateValue.currentMetaverse.name}</title>
            <Box flex='1' h='300px' bg={bg} py="7.5em"  >
                <Flex justifyContent='left' bg={boxBg} borderBottom='1px solid' borderTop='1px solid' borderColor='blue.500'>
                    ...
                    <Box display='flex' flexDirection='row'  alignItems='center' maxWidth='860px' >
                                ...
                                <Button variant={isFavorite ? 'favorite' : 'addFavorite'} 
                                 isLoading={loading} 
